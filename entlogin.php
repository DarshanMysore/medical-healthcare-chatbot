...
?>
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="http://localhost/pocketclinic/">Mobile Clinic</a>
   ...
   <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item active" href="index.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">HOME</span></a></li>
		 <li><a class="app-menu__item active" href="index.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">KNOW MORE</span></a></li
		  <li><a class="app-menu__item active" href="index.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">OUR SERVICES</span></a></li>
         </ul>
		 </aside>
    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
          <h1><i class="fa fa-dashboard"></i> Medical service provider login</h1>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
          <div class="form">
<h1>Medical service provider login</h1>
