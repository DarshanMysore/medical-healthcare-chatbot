...
<html lang="en">
  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="entprofile.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Medical service provider profile</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
          <h1><i class="fa fa-dashboard"></i>Medical service provider profile </h1>
...
?>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">ABOUT MOBILE CLINIC</h3>
            <ul>
...
User can search the nearest medical store and diagnosis lab from his location </li>
		 ...
		 <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Medical service provider Registeration</h3>
            <div class="tile-body">
             <form class="form-horizontal" action="" method="post">
                ...
                <div class="form-group row">
                  <label class="control-label col-md-3">OWNER ID</label>SS
                  <div class="col-md-8">
