...
<html lang="en">
  ...
  <body class="app sidebar-mini" >
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="#">Healthcare Clinic</a>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="addtreatment.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Add treatment</span></a></li>
            ...
            <div class="tile-body">
              <form class="form-horizontal" action="" method="post">
				...
				<div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" value="<?php echo $data['phonenumber']; ?>" type="number" value="+91" maxlength="10" placeholder="Enter phone number" readonly>
                  </div>
                </div>
                <div class="form-group row">
