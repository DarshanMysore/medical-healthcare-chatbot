...
var citiesByState = {
headache_problems: ["seeing zig-zagging lines, flickering lights, or spots.","Partial loss of vision.","pins and needles","muscle weakness","difficulty speaking."],
muscle_or_joint_problems: ["Ankle pain problem","hot, burning, shooting or stabbing pains in your back and sometimes into one or both of your legs","Elbow swelling"],
skin_problems: ["Acne Commonly located on the face, neck, shoulders, chest, and upper back","Red, painful, fluid-filled blister that appears near the mouth and lips","Characterized by watery, clear, fluid-filled area on the skin"],
heart_problem: ["Chest pain, chest tightness, chest pressure and chest discomfort (angina)","Shortness of breath","Pain in the neck, jaw, throat, upper abdomen or back"],
...
document.getElementById("citySelect").selectedIndex = 0;
  ...
  <body class="app sidebar-mini" onload="resetSelection()">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="#">Mobile Clinic</a>
  ...
  <li><a class="app-menu__item" href="emmergency.php"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Emmergency request</span></a></li>0
  <li><a class="app-menu__item" href="http://localhost/healthcare/chat.php"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Chat </span></a></li>
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <option value="HASSAN">HASSAN</option>
               ...
               <option value="DHARVAD">DHARVAD</option>
               ...
               <option value="KOPPAL">KOPPAL</option>
                ...
                <div class="form-group col-md-3">
                  <label class="control-label">SPECIALIST TYPE/ HOME VISIT DOCTOR</label>
                 	<select class="form-control" name="ppp" required id="countrySelect" size="1" onchange="makeSubmenu(this.value)">
			 ...
			 <option value="cardiology"> Anesthesiologist</option>
              ...
              <option value="orthopedics">orthopedics</option> 
               ...
               <option value="Dermatologist">Surgeon</option>
               <option value="Dermatologist">Pediatrician</option>   
               <option value="Dermatologist">Pulmonologist</option>
               <option value="Dermatologist">Radiologist</option>  
			   			   <option value="homevisit"><strong>HOME VISIT</strong></option>  
            </select>
                </div>
