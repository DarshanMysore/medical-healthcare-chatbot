...
<html lang="en">
  ...
  <li><a class="app-menu__item" href="/medicalchatbotcopy/Healthcare/chat.php"><i class="app-menu__icon ffa fa-anchor"></i><span class="app-menu__label">Chatbot</span></a></li>
...
?>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">ABOUT HEALTHCARE CLINIC</h3>
            <ul>
