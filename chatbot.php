...
<html lang="en">
 ...
 <li><a class="app-menu__item active" href="chatbot.php"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">CHAT BOT</span></a></li>
              ...
              <div class="col-lg-6">
                <form action="emmergencydb.php" method="post">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="number" name="p2" value="<?php echo $data['phonenumber']; ?>" required readonly>
                  </div>
                  <div class="form-group">
