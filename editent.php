...
<html lang="en">
  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item active" href="entprofile.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Medical service provider profile</span></a></li>
