...
var citiesByState = {
Heart_Problem: ["cardiologist"],
Kidney_Problem: ["Nephrologist"],
Bone_Problem: ["Dermatologist"],
Respiratory: ["Pulmonologist"],
Thyroid_Problem: ["Endocrinologists"],
Diabetes_Problem: ["Endocrinologists"],
Cancer_Problem: ["Oncologists"],
}
...
document.getElementById("citySelect").selectedIndex = 0;
  ...
  <body class="app sidebar-mini"  onload="resetSelection()">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="#">Mobile Clninic</a>
  ...
  <li><a class="app-menu__item" href="/medicalchatbotcopy/healthcare/chat.php"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Chat </span></a></li>
               ...
               <option value="KOPPAL">KOPPAL</option>
                ...
                <div class="form-group col-md-3">
                  <label class="control-label">SELECT SYMPTOMS</label>
                 	<select class="form-control" name="pppp" id="countrySelect" size="1" onchange="makeSubmenu(this.value)">
			  <option value="NULL">---SELECT SYMPTOMS--</option>
			 <option value="Heart_Problem"> Heart Problem</option>
       <option value="Kidney_Problem"> Kidney Problem</option>
       <option value="Bone_Problem"> Bone Problem</option>
       <option value="Respiratory"> Respiratory Problem</option>
       <option value="Thyroid_Problem"> Thyroid Problem</option>
       <option value="Diabetes_Problem"> Diabetes Problem</option>
       <option value="Cancer_Problem"> Cancer Problem</option>   
            </select>
                </div>
                <div class="form-group col-md-3">
                <label class="control-label">SPECIALIST TYPE/ HOME VISIT DOCTOR</label>
                 
			    		   <select id="citySelect"  name="ppp"required class="form-control input-md" size="1" >
<option value=""  value="" disabled selected>---SPECIALIST TYPE--</option>
<option></option>
</select>		</div>
