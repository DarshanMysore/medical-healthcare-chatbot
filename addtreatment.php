  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="appointmentnotification.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Appointment Request</span></a></li>
        ...
        <li><a class="app-menu__item active" href="addtreatment.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Add Treatment</span></a></li>
            ...
            <div class="row">
              <div class="col-lg-6">
                <form action="treatmentdb.php" method="post">
                  ...
                  <div class="form-group">
                  <p>PATIENT STATUS</p><br>
                    <input type="radio" id="Normal"  name="fav_language" value="Normal">
                      <label for="Normal">Normal</label>
                    <input type="radio" id="Critical" name="fav_language" value="Critical">
                      <label for="Critical">Critical</label>
                    <input type="radio" id="Need to be observation" name="fav_language" value="Need to be observation">
                    <label for="Need to be observation">Need to be observed</label>

					<!--<input type="radio" class="form-control" name="p2" value="NORMAL" checked>NORMAL<br>
          <input type="radio"class="form-control" name="p2" value="CRITICAL" checked>CRITICAL<br>
          <input type="radio" class="form-control" name="p2" value="OBSERVATION" checked> NEED TO OBSERVATION <br>-->
             ...
             <p>CHOOSE MEDICINE INFORMATION </p>
              ...
              <select class="form-control" id="demoSelect" name="p4" multiple="">
                <optgroup label="Select MEDICINE" >
                  ...
                  <option value="Pain Killer 500 mg">Pain Killer 500 mg</option>
                  <option value="Crosin 250 mg">Crosin 250 mg</option>
                  <option value="Paracetamol 250 mg">Paracetamol 250 mg</option> 
                  <option value="Saridon 120 mg">Saridon 120 mg</option> 
